Data are presented measuring “The Effect of Vitamin C on Tooth Growth in Guinea Pigs.” The response is the length of odontoblasts (teeth) in each of 10 guinea pigs at each of three dose levels of Vitamin C (0.5, 1, and 2 mg) with each of two delivery methods (orange juice or ascorbic acid).
...
variable, representing the two different delivery methods. Therefore we should look at some summary statistics for each of the two factors taken separately.
...
## mean of x mean of y 
##  16.96333  20.66333
A 0.06 p value, a small-ish t statistic, and the 95% confidence interval including zero all indicate that we must fail to reject the null hypothesis, and we must assume that these differences could be do to chance.
